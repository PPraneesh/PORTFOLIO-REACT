      ...
      <div className="post">
        <h2>Allow Me To Introduce Myself</h2>
        {
          <p style={{ textAlign: "justify" }}>
            Heya I`m Parshi Praneesh, a web developer with expertise in
            languages like
            ...
            team mastered Python for web development in a day and built a
            winning chatbot with GPT-3.5`s API and MongoDB in just two days.
            <br />
            <br />
